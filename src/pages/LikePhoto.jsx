...
export default function LikePhoto() {
  ...
  const { isLoading, isFetching, error, data : result } = useQuery(['images'], () => getImageinfo(user.uid));
  ...
  return (
    ...
    <div className="bg-white">
      <div className="mx-auto py-16 px-4 sm:py-0 sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-black justify-start">좋아요 한 사진</h2>
        <Masonry
